...
- `activeTab`: Grant temporary host access only after explicit user actions
  (context-menu click or extension command).
- `scripting`: Run text extraction functions in the user-invoked active tab
  without persistent content script injection or broad host permissions.
