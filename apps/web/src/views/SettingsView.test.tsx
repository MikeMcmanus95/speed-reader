...
describe('SettingsView', () => {
  ...
  it('explains immediate vs default-applied settings behavior', () => {
    render(
    ...
    expect(
      screen.getByText(
        'Customize your reading experience. Font size applies immediately; other settings are defaults for new documents.'
      )
    ).toBeInTheDocument();
  });
